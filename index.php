    ...
    <section class="popular">
        <div class="container">
            ...
            <div class="row">
                ...
                <?php 					
    $query_res = mysqli_query($db, "SELECT * FROM MENUS ORDER BY menus_name LIMIT 6"); 
    while($r = mysqli_fetch_array($query_res)) {
        echo '<div class="col-xs-12 col-sm-6 col-md-4 food-item">
                <div class="food-item-wrap">
                    <div class="figure-wrap bg-image" data-image-src="admin/Res_img/dishes/131.jpg"></div>
                    <div class="content">
                        <h5><a href="dishes.php?res_id=' . $r['id'] . '">' . $r['menus_name'] . '</a></h5>
                        <div class="price-btn-block"> <span class="price">$' . $r['menus_amountMin'] . ' - $' . $r['menus_amountMax'] . '</span> <a href="dishes.php?res_id=' . $r['id'] . '" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                    </div>
                </div>
            </div>';                                      
    }	
?>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="restaurant-listing">
                    ...
                    <?php  
    $query = "SELECT r.id, r.tag, r.categories, l.address, l.city FROM RESTAURANTS r JOIN LOCATIONS l ON r.id = l.restaurant_id limit 6";
    ...
    <a class="restaurant-logo" href="dishes.php?res_id=' . $row['id'] . '"> <img src="admin/Res_img/6290860e72d1e.jpg" alt="Restaurant logo"> </a>

                        </div>
                        <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                            <h5><a href="dishes.php?res_id=' . $row['id'] . '">' . $row['tag'] . '</a></h5> 
